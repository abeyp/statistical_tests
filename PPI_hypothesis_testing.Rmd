...
-   Non-dropout defined as a participant with AHI and CESD scores
    provided in all 6 occasions.
...
```{r}
# Table of gender for dropout.df
...
![](images/Screenshot%202023-05-03%20at%201.12.55%20PM.png){width="300"}

## Intervention Groups with Chi-Square Test

```{r}
'''
INTERVENTION GROUP with X-SQUARED TEST
...
![](images/Screenshot%202023-05-03%20at%201.20.27%20PM.png){width="300"}

## Difference in Education Level with Wilcoxon Test

```{r}
'''
EDUCATION with wilcoxon test 
...
wilcox.test(x = non.dropout.df$educ, y = dropout.df$educ, alternative = "two.sided")
...
#H_0: No difference between intervention groups of dropout and non.dropouts
'''
wilcox.test(x = non.dropout.df$income, y = dropout.df$income, alternative = "two.sided")
